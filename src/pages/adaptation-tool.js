...
import exposure_legend from "../../public/images/exposure_legend.jpg"
import vulnerability_legend from "../../public/images/vulnerability_legend.jpg"
...
const MapDatasetOptions = [
    {
        ...
        Components: [
            ...
            },
            {
                name: "Exposure index",
                value: "exposure",
                legendImg: exposure_legend
            },
            {
                name: "Vulnerability index",
                value: "vulnerability",
                legendImg: vulnerability_legend
            },
            {
                name: "Risk index",
                value: "risk",
                legendImg: risk_legend
            },
        ]
    },
    {
        ...
        if (selectedSector && selectedSector.Sector && selectedState && selectedComponent) {
            const fetchData = async () => {
                try {
                    ...
                    const geojsonresponse = await import(`../../public/data/shapefiles/IndiaDistricts_2011.json`);
    ...
    return (
        <>
            <Head>
                ...
                <title>Climate risk and adaptation tool</title>
            </Head>
