...
const DecesionSupportMap = ({ selectedState, selectedDistrict, selectedDataQuery, selectedTehsil, filteredIndiaDistrict, selectedVariable, uploadeddata, mapNumber }) => {

  const [selectedData, setSelectedData] = useState(null);
  const [loading, setLoading] = useState(false);

  useEffect(() => {
    if (selectedState && selectedDataQuery && selectedDataQuery.DataValue === "MonsoonData") {
  ...
  }, [selectedState, selectedDataQuery]);
