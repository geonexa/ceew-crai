            ...
            >
                ...
                {geojsonJsonData && selectedComponent && (
                    ...
                    <>
                        ...
                        <div className="legend_panel_container" style={{ width: "300px", bottom: "25px", right: "10px", backgroundColor: "whitesmoke", borderRadius: "5px", }}>
                            <Image style={{ width: "100%" }} src={selectedComponent.legendImg} alt='Legend' />
                        </div>
